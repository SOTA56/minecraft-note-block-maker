...
export type BlueprintSettings = { runLength:number; compactSize?:number; fold:'right'|'left'; includeSilentEdges:boolean; theme?:'dark'|'light'; fishboneMode?:FishboneMode; fishboneManual?:Record<string,number[]> }
